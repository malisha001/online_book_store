...
<body>
    ...
    <div class="orderremovecontainer">
            ...
            <div class="orderremoveform">
                <form action="removeorder.php" method="post">
                        <div class="col">
                            <h3 class="title">remove order</h3>
            
                            <div class="inputBox">
                                <span>order ID :</span>
                                <input type="text" placeholder="0xxxxxx" name="orderid">
                            </div>
                        </div>
                    <input type="submit" value="Remove order" class="submit-btn">
                </form>
            </div>
