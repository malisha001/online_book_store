...
<body>
    ...
    <div class="bookbuttons">
        <h1>Manage Books</h1>
        <a class="cta" href="pages/addbooks/index.php">
            <button class="headbuttons">Add Books</button>
        </a>
        <a class="cta" href="pages/removebooks/index.php">
            <button class="headbuttons">Remove Books</button>
        </a>
    </div>
