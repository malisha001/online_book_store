...
<body>
    ...
    <div class="removebookscontainer">
        
            <div class="removebookform">
                <form action="removebook.php" method = "post">
                        <div class="col">
                            <h3 class="title">Remove Book</h3>
            
                            <div class="inputBox">
                                <span>book ID :</span>
                                <input type="text" placeholder="Bxxx" name="bookid">
                            </div>
                        </div>
                    <input type="submit" value="Remove Book" class="submit-btn">
                </form>
            </div>
